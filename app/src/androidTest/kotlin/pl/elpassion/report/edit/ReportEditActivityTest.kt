...
class ReportEditActivityTest {
    ...
    fun shouldShowCorrectReportDate() {
        startActivity(newHourlyReport(year = 2010, month = 2, day = 10))
    ...
    fun shouldHaveCorrectProjectName() {
        startActivity(newHourlyReport(project = newProject(name = "newProject")))
        onId(R.id.reportEditProjectName).hasText("newProject")
    }

    @Test
    fun shouldReallyHaveCorrectProjectName() {
        startActivity(newHourlyReport(project = newProject(name = "project 123")))
    ...
    fun shouldHaveOldPreviousHoursValueAtTheBegging() {
        startActivity(newHourlyReport(reportedHours = 2.32))
    ...
    fun shouldHaveCorrectDescription() {
        startActivity(newHourlyReport(description = "Sample description"))
        onId(R.id.reportEditDescription).hasText("Sample description")
    }

    @Test
    fun shouldHaveCorrectProjectDisplayedIfItHasBeenChanged() {
        startActivity(newHourlyReport(project = newProject(name = "project1")))
    ...
    fun shouldCallApiWithCorrectData() {
        startActivity(newHourlyReport(project = newProject(id = 1), description = "test1", reportedHours = 2.0, year = 2010, month = 10, day = 1, id = 2))
    ...
    fun shouldCallRemoveReportApiAfterClickOnRemove() {
        startActivity(newHourlyReport(id = 2))
    ...
    private fun startActivity(report: HourlyReport = newHourlyReport()) {
