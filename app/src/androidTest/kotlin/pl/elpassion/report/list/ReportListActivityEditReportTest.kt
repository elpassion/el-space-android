...
class ReportListActivityEditReportTest {
    ...
    val rule = rule<ReportListActivity> {
        ...
        whenever(service.getReports())
                ...
                .thenReturn(Observable.just(listOf(newHourlyReport(year = 2016, month = 10, day = 1, project = newProject(name = "Project"), description = "new Description", reportedHours = 8.0))))
