...
class PaidVacationReportItemAdapter(val report: PaidVacationHourlyReport, val onReportClick: OnReportClick) : StableItemAdapter<PaidVacationReportItemAdapter.VH>(report.id, R.layout.paid_vacations_report_item) {
    override fun onCreateViewHolder(itemView: View) = VH(itemView)

    override fun onBindViewHolder(holder: VH) {
        holder.itemView.run {
            setOnClickListener { onReportClick(report) }
