...
class ReportDayService(private val observeDateChange: DateChangeObserver,
                       private val reportListApi: ReportList.Service) {
    ...
    fun observeDateChanges() = observeDateChange.observe()
}