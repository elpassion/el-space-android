...
interface ReportList {
    ...
    interface View {
        fun showDays(days: List<RegularDay>, onDayClickListener: OnDayClickListener, onReportClickListener: OnReportClickListener)
        ...
        fun openEditReportScreen(report: HoursReport)
