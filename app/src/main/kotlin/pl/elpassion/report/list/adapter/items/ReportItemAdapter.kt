...
class ReportItemAdapter(val report: HoursReport, val onReportClickListener: OnReportClickListener) : StableItemAdapter<ReportItemAdapter.VH>(report.id, R.layout.report_item) {
