...
fun createComment(id: Long = 22, userInitials: String = "FL", name: String = "First Last", content: String = "Message", createdAt: Long = 456, userId: Long = 1, status: String = "accepted", wasShown: Boolean = false) =
        Comment(id = id, userInitials = userInitials, userInitialsBackgroundColor = "#ff3333", fullName = name, content = content, createdAt = createdAt, userId = userId, status = status, wasShown = wasShown)
