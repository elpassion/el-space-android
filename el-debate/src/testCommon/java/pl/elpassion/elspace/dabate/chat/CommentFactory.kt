...
fun createInitialsComments(debateClosed: Boolean = false, comments: List<Comment> = createComments()) =
        InitialsComments(debateClosed = debateClosed, comments = comments)
