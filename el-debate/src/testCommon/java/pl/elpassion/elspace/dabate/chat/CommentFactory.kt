...
fun createComment(name: String = "First Last", userId: Long = 1) = Comment(fullName = name, createdAt = 456, userInitials = "FL", userInitialsBackgroundColor = "#ff3333", content = "Message", userId = userId)
