...
class PacManActivity : AppCompatActivity(), PacMan.View {
    ...
    val controller by lazy {
        PacManController(this, PacManMapView(mapView), PacManPositionService(this), PlayersServiceImpl(WebSocketClientImpl("ws://192.168.1.19:8080/ws", WebSocketClientApiImpl())))
    }
